export type UserRole = 'customer' | 'admin' | 'delivery_partner' | 'stall_owner' | 'vendor';
...
/** Geometry and metrics returned by the road routing service. */
