...
<<<<<<< HEAD
    <div className="space-y-6 font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="font-serif text-2xl font-black text-[#3c1e0a] tracking-tight flex items-center gap-2">
...
<<<<<<< HEAD
        ...
        <div className="bg-[#fff8f2]/95 rounded-3xl border border-[#f0bd9b] shadow-xs overflow-hidden backdrop-blur-sm">
